  ...
  const UpdateAllUerList = () => {
    ...
    const getAllDetailsById = async () => {
      try {
        let details = await callApi("get", `/singleadmin/${id}`);
        setSchoolDetails(details.data.user);
    ...
    const onSubmit = async (data) => {
      try {
        let details = await callApi("put", `/updateadmin/${id}`, data);
                  ...
                  <Grid>
                    ...
                    <Grid>
                      <TextField
                        ...
                        fullWidth
                        variant="standard"
                        defaultValue={schoolDetails.email}
                        type="email"
                        name="email"
                        autoComplete="off"
                        className="my-2"
  ...
  export default UpdateAllUerList;
